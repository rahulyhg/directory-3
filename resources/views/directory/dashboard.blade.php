        ...
        <div class="col-md-12">
            <h1>
                ...
                <span class="action-btns pull-right">
                    <a href="/families/create" class="btn btn-primary"><i class="fa fa-plus"></i>Add Family</a>
            ...
            <table class="table table-striped">
                <tr>
                    <th>
                        ...
                        <a href="{{ action('FamilyController@dashboard', ['sort_by' => 'name', 'direction' => $direction] ) }}">
                            Name
                    ...
                    <th>
                        ...
                        <a href="{{ action('FamilyController@dashboard', ['sort_by' => 'updated_at', 'direction' => $direction] ) }}">
                            Last Updated
                    ...
                    <th>
                        ...
                        <a href="{{ action('FamilyController@dashboard', ['sort_by' => 'status_id', 'direction' => $direction] ) }}">
                            Status
                ...
                @foreach ($families as $family)
                    <tr>
                        <td>
                            ...
                            @else
                                <a href="/families/{{ $family->slug }}">{{ $family->name }}@if($family->head), {{ $family->head->first_name }}@endif</a>
                            @endif
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="action-btns-no-text pull-right">
                                ...
                                <a style="margin: 0 5px;" class="btn btn-default" href="{{ url('families/' . $family->slug . '/edit') }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                                <form style="display: inline-block;" method="POST" action="{{ url('families/' . $family->id) }}">
                                    {!! csrf_field() !!}
                                    {{ method_field('DELETE') }}
